...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.RequestDetailCapture())
	{
	...
	relaySunoRouter.Use(middleware.RequestDetailCapture())
	{
